...
- [ ] 增加默认文件首页：支持文件/文件夹拖入、本地轻量识别、按文件族分组和推荐工具，不自动执行。
- [ ] 将兼容图片、GIF 与文本文件显式流转到已有工作台，并提供可解释的常用预设。
- [ ] 识别 JPG/JPEG/PNG/WebP/AVIF/GIF/SVG/BMP/TIFF/HEIC/ICO、PDF、TXT/Markdown/HTML/
