...
import zhHantJson from './translations/zh-Hant.json';
...
export const zhHantTranslations = zhHantJson as unknown as Translations;
...
const translators: Record<Locale, (key: string, params?: TranslateParams) => string> = {
  ...
  'zh-Hant': createTranslator(zhHantTranslations),
