...
(function (global) {
  ...
  function build(current) {
    ...
    if (settingsApp && settingsApp.status === "stable") {
      settingsLink = el("a", "toolbox-nav-icon-btn toolbox-nav-settings");
      settingsLink.href = settingsApp.path;
    var settingsLang =
      global.ToolboxI18n && typeof global.ToolboxI18n.getLang === "function"
        ? global.ToolboxI18n.getLang()
        : "zh";
    var settingsTitle = settingsLang === "en" ? "Settings" : "设置";
      settingsLink.setAttribute("aria-label", settingsTitle);
      settingsLink.setAttribute("title", settingsTitle);
